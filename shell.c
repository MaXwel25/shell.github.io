...
void show_help() {
    ...
    printf(" print_once\n");
    printf(" print_loop (выход по Ctrl+D)\n");
    printf(" echo\n");
    printf(" history\n");
    printf(" exit или \\q - Выход\n");
    printf(" help\n");
    printf(" \\e <*> \n");
    printf(" \\bin <бинарник> - Выполнить указанный бинарник.\n");
    printf(" \\l <путь> - Получить информацию о разделе в системе.\n");
    printf(" \\cron - Подключить VFS в /tmp/vfs.\n");
    printf(" \\mem <procid> - Получить дамп памяти процесса.\n");
